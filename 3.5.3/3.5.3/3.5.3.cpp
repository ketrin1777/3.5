// 3.5.3.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
public:
	...
	void print_info() override {
		...
		std::cout << "Углы: A=" << get_A() << " A=" << get_B() << " C=" << get_C() << std::endl;
	};
...
public:
	...
	void print_info() override
	{
		...
		std::cout << "Углы: A=" << get_A() << " A=" << get_B() << " C=" << get_C() << " D=" << get_D() << std::endl;
	}
